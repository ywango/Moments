...
public class EventAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position < 3) {
            eventImage.setImageDrawable(context.getDrawable(R.drawable.bird));
        } else if (position >= 3 && position < 6) {
            eventImage.setImageDrawable(context.getDrawable(R.drawable.kitty));
        } else if (position >= 6 && position < 9) {
            eventImage.setImageDrawable(context.getDrawable(R.drawable.frog));
        } else {
            eventImage.setImageDrawable(context.getDrawable(R.drawable.dog));
        }
